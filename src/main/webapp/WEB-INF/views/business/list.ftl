                ...
                <div style="margin: 20px 0px 0px 10px">
                    <form class="form-inline" id="searchForm" action="/business/list" method="post">
                        <input type="hidden" name="currentPage" id="currentPage" value="1">
                                ...
                                <div class="form-group">
                                    <label>经营日期查询：</label>
                                    <input placeholder="请输入开始日期" type="text" class="form-control input-date"  name="beginOpenDate"
                                           value="${(qo.beginOpenDate?string('yyyy-MM-dd'))!}" /> -
                                    <input placeholder="请输入结束日期" type="text" class="form-control input-date"  name="endOpenDate"
                                           value="${(qo.endOpenDate?string('yyyy-MM-dd'))!}" />
                                </div>
                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                        <#list pageInfo.list as business>
                            ...
                            <td>${business.openDate?date}</td>
                                <td>${business.mainStore?string('
                                <span class="label label-primary">总店</span>','
                                <span class="label label-default">分店</span>')}
                            </td>
                            <td>
