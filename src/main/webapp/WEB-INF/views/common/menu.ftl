        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li name="systemDictionary"><a href="/systemDictionary/list"><i class="fa fa-circle-o"></i> 数据字典</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li name="customerReport"><a href="/consumptionReport/list"><i class="fa fa-circle-o"></i>潜在客户报表</a>
                    </li>
                </ul>
            </li>
