    ...
    <#list pageInfo.list as messageBoard>
        <div class="box box-widget">
            ...
            <div class="box-body">
                ...
                <span class="pull-right text-muted">${(messageBoard.replystatus?string('
                                <span class="label label-primary">已回复</span>','
                                <span class="label label-default">没回复</span>'))! }<a href="/messageBoard/detailPage?id=${messageBoard.id}">查看详情</a></span>
            </div>
        </div>
    </#list>
...
<div class="modal fade" id="messageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog " style="max-width: 380px;">
        <div class="modal-content">
            ...
            <form id="appointmentForm" method="post" action="/messageBoard/saveOrUpdate">
